 ...
 */
public class Paging {
	public static String getPaging(String ownid,String pageURL,int nowPage, int rowTotal,int blockList, int blockPage){
...
//------페이지 목록 출력 -------------------------------------------------------------------------------------------------
		...
		for(int i=startPage; i<= endPage ;i++){
			...
			if(i == nowPage){ //현재 있는 페이지
				sb.append("&nbsp;<li class='page-item'><a class='page-link'><font color='#03657d'>");
				sb.append(i);
				sb.append("</font></a></li>");
			}
			else{//현재 페이지가 아니면
				sb.append("&nbsp;<li class='page-item'><a class='page-link' href='"+pageURL+"?ownid="+ownid+"&page=");
				sb.append(i);
