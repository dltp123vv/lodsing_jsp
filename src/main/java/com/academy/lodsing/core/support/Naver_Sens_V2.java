package com.academy.lodsing.core.support;
...
public class Naver_Sens_V2 {
   ...
   public void send_msg(String tel, String rand) {
        ...
        String accessKey = "rWaZlPvw8Q9tvKlid5C6";                                       // 개인 인증키
        String secretKey = "976e4b90c1994ca4b08d27043bc51d88";                                // 2차 인증을 위해 서비스마다 할당되는 service secret
        String serviceId = "ncp:push:kr:293853148908:leesehun";                                   // 프로젝트에 할당된 SMS 서비스 ID
       ...
       bodyJson.put("from","01088832761");   // 발신번호 * 사전에 인증/등록된 번호만 사용할 수 있습니다.      
